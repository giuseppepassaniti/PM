...
export function renderProjectsView(container, appState) {
    ...
    // Inseriamo tutto nel contenitore principale
    container.innerHTML = `
        <header class="mb-6">
            <h2 class="text-3xl font-bold text-slate-900">Dashboard Progetti</h2>
            <p class="text-slate-600 mt-1">Seleziona un progetto per visualizzare i dettagli.</p>
        </header>
